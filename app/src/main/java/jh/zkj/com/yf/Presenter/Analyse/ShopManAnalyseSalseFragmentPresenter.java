...
import jh.zkj.com.yf.Contract.Analyse.ShopManAnalyseSalseFragmentContract;
...
public class ShopManAnalyseSalseFragmentPresenter implements ShopManAnalyseSalseFragmentContract.ShopManAnalyseSalseFragmentpresent {
    ShopManAnalyseSalseFragment fragment;
    ...
    public ShopManAnalyseSalseFragmentPresenter(ShopManAnalyseSalseFragment fragment) {
    ...
    private void initTable(PieDataBean bean) {
        ...
        fragment.getShopManSalesTableList().setAdapter(adapter);
    }
        ...
        analyseAPI.LineDate(context, "qty", companyCode, startDate, endDate, classifyUuid, brandUuid, skuName,
                companyUuid,searchType, new AnalyseAPI.IResultMsg<LineDataBean>() {
                    ...
                    public void Result(LineDataBean bean) {
                        ...
                        context.shopManAnalysePresent.setStartDate(startDate);
                        context.shopManAnalysePresent.setEndDate(endDate);
                        context.shopManAnalysePresent.setClassify(classifyUuid);
                        context.shopManAnalysePresent.setBrand(brandUuid);
                        context.shopManAnalysePresent.setModle(skuName);
                        context.shopManAnalysePresent.setCompanyCode(companyCode);
                        context.shopManAnalysePresent.setShopName(shopName);
    ...
    public void initChart(LineDataBean bean) {
        ...
        mLineChart = fragment.getShopManSalesChart();
...
//        }
    ...
    private void initPieChar(PieDataBean bean) {
        pieChart = fragment.getShopManSalesPieChart();
        //模拟数据
