...
import jh.zkj.com.yf.Activity.Insurance.InsureConfirmActivity;
 ...
 * use
 */
public class InsureConfirmPresenter {

    private final InsureConfirmActivity activity;
    private RecyclerView recycle;
    private TitleLayout titleLayout;

    public InsureConfirmPresenter(InsureConfirmActivity activity) {
