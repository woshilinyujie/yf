...
import jh.zkj.com.yf.Presenter.Analyse.ShopManAnalysePresenter;
...
public class ShopManAnalyseActivity extends MBaseActivity implements ShopManAnalyseContract.ShopManAnalyseView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shopManAnalysePresent = new ShopManAnalysePresenter(this);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.shop_analyse_select_shop://门店选择
                shopManAnalysePresent.selectShop(shopAnalyseSelectDataRl);
                shopManAnalysePresent.setShopNameListener();
                break;
            case R.id.shop_analyse_select_data_ll://时间选择
                shopManAnalysePresent.selectData(shopAnalyseSelectDataRl);
                shopManAnalysePresent.setInfoListener();
                break;
        }
    }
